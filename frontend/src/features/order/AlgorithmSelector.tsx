      ...
      <p id="algorithm-description" className="summary-note">
        {demo
          ...
          : settings.algorithm === 'z3'
            ? 'Ищет оптимальный план. Для больших заказов поиск может не завершиться за выбранное время.'
            : 'Быстро сравнивает несколько вариантов укладки. Не гарантирует математический оптимум.'}
      </p>
      {!demo && (
